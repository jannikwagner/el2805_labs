...
def dqn(env, agent, N_episodes, C, buffer_size, discount_factor):
    ...
    for k in EPISODES:
        ...
        while not done:
            ...
            if len(buffer) < buffer_size:
                ...
                # buffer.get()
                # buffer.put(obs)
                # buffer[random.randint(0, buffer_size-1)] = obs
                buffer.pop(0)
                buffer.append(obs)
...
dqn(env, agent, N_episodes, C, buffer_size, discount_factor)
