...
from problem1f import plot3d_values
...
device = "cpu"  # I can't test on gpu
load_model = False
...
# use random agent for simulation
...
print("Random agent")
check_solution(random_agent, env, render=False)
...
# 1.f)
plot3d_values(n_actions, device, experiment_name, network)
