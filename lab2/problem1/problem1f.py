...
def plot3d_values(n_actions, device, exp_name, network):
    res = 50
    y_min, y_max = 0, 1.5
    ...
    ax.set_title(f'Value function of {exp_name}')
    ax.set_xlabel('y')
    ax.set_ylabel('w')
    ax.set_zlabel('V(s)')
    ...
    ax.set_title(f'Action landscape of {exp_name}')
    ax.set_xlabel('y')
    ax.set_ylabel('w')
...
if __name__ == "__main__":
    ...
    plot3d_values(n_actions, device, exp, network)
